...
namespace Battlehub.RTCommon
{
    ...
    public class RuntimeEditorWindow : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler
    {
        ...
        {
            bool isPointerOver = cameraRect.Contains(Input.mousePosition) && (EventSystem.current == null || !EventSystem.current.IsPointerOverGameObject());
